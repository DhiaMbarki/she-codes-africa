    ...
    try {
        ...
        var CLoudinary_idCL = result.id;
         const dts = { IdFb:req.body.IdFb ,PhotosprofileUrl:PhotosprofileUrlCL, CLoudinary_id:CLoudinary_idCL, 
            ...
            Biography:req.body.Biography, Location:req.body.Location,
            Githubacountlink:req.body.Githubacountlink, Linkedincountlink:req.body.Linkedincountlink, 
            Websiteurl:req.body.Websiteurl, Engineeringareas:req.body.Engineeringareas, Gender:req.body.Gender, 
            Howcanwehelpyousucced:req.body.Howcanwehelpyousucced,
            Companyname :req.body.Companyname, Jobtitle :req.body.Jobtitle, YearsOfexperience:req.body.YearsOfexperience, 
            Codingstackinuse:req.body.Codingstackinuse, Codingstacktolearn:req.body.Codingstacktolearn } 
