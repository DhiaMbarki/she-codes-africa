      ...
      <div className="wrapper">
        <article>
          ...
          <div className="desc full">
            <h4 className="subtitle">We code africa.</h4>
            <p>
          ...
          <div className="desc">
            ...
            <p>
              For the back-end I also work with Javascript (NodeJS, Express, fireBase, ). But, of
              course, whenever the project requires react, I do react as well (redux, react-native).
            </p>
          </div>
          <div className="desc">
