...
return (
    <div class="container">
        <div class="colum1">
            ...
            <p id="lable" fontSize="3xl" as="samp" color="black" as="cite" >Name</p><br></br>
            <p id="name" fontSize="2xl" as="samp" color="black" as="samp" >Ghassen</p><br></br>
        </div>
        <div class="aboutme">
            <p fontSize="3xl" color="black" as="cite" >About me</p><br></br>
            <p fontSize="lg" as="em"> In love with React  Next</p>
            <div class="link">
